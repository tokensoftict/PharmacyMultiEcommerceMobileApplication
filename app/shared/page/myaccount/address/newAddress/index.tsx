                    ...
                    isStateLoading
                        ...
                        <View style={{padding: normalize(24)}}>
                            <TouchableOpacity onPress={() => triggerStateDialog(false)} style={{flexDirection: 'row', alignItems: 'center'}}>
                                <Typography style={{fontWeight: '700', width :'100%', fontSize: normalize(18), marginBottom: normalize(10), textAlign: 'center'}}>{"Select State"}</Typography>
                            </TouchableOpacity>
                            <FlatList
                    ...
                    isTownLoading
                        ...
                        <View style={{padding: normalize(24)}}>
                            <TouchableOpacity onPress={() => triggerTownDialog(false)} style={{flexDirection: 'row', alignItems: 'center'}}>
                                <Typography style={{fontWeight: '700', width :'100%', fontSize: normalize(18), marginBottom: normalize(10), textAlign: 'center'}}>{"Select Town."}</Typography>
                            </TouchableOpacity>
                            <FlatList
                                style={{height:normalize(420)}}
                                data={towns}
